...
- [BeanFactory vs ApplicationContext in Spring](#beanfactory-vs-applicationcontext-in-spring)
- [Bean Life Cycle](#bean-life-cycle)
    ...
    - [Custom Init Method](#custom-init-method)
    - [Custom Utility Method](#custom-utility-method)
    - [Destruction](#destruction)
    - [Ways to Implement Bean Life Cycle in Spring](#ways-to-implement-bean-life-cycle-in-spring)
- [Singleton and Prototype Bean Scopes](#singleton-and-prototype-bean-scopes)
    - [Singleton Scope](#singleton-scope)
    - [Prototype Scope](#prototype-scope)
- [Custom Bean Scope](#custom-bean-scope)
    - [When to Use Custom Scopes](#when-to-use-custom-scopes)
    - [How to do it?](#how-to-do-it)
        - [Implement the `Scope` Interface](#implement-the-scope-interface)
        - [Register the Custom Scope](#register-the-custom-scope)
        - [Apply the Scope to a Bean](#apply-the-scope-to-a-bean)
- [3 Ways to Create Spring Beans](#3-ways-to-create-spring-beans)
    - [XML Configuration (Legacy)](#xml-configuration-legacy)
    - [Annotation-Based (Modern Standard)](#annotation-based-modern-standard)
    - [Java-Based Configuration (Flexible & Typesafe)](#java-based-configuration-flexible--typesafe)
- [Spring Autowiring](#spring-autowiring)
    - [Autowiring Modes (XML Legacy)](#autowiring-modes-xml-legacy)
    - [Modern Autowiring: `@Autowired`](#modern-autowiring-autowired)
        - [Field Injection](#field-injection)
        - [Setter Injection](#setter-injection)
        - [Constructor Injection](#constructor-injection)
    - [Handling Ambiguity: `@Qualifier`](#handling-ambiguity-qualifier)
